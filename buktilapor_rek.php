...
<div class="container mx-auto p-4">
  <div class="bg-white rounded-lg shadow-md p-8">
    ...
    <a class="btn btn-primary" href="suratrekrutmen.php">Cetak Bukti</a>
    </div>
  </div>
</div>
</body>
