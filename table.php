...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <h2 style="padding-top: 90px; padding-left: 80px; font-size: 18pt;"> Register PKWT TA</h2>
          ...
          <table class="table table-striped"  style="font-size: 9pt;">
            ...
            <tbody>
              ...
              <?php
                ...
                $sql = "SELECT * FROM reg_tbl ";  // Ganti "nama_tabel" dengan nama tabel Anda
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["AWALAN"] . "</td>";
                        echo "<td>" . $row["TENGAH"] . "</td>";
                        echo "<td>" . $row["AKHIR"] . "</td>";
                        echo "<td>" . $row["KARYAWAN_SATU"] . "</td>";
                        echo "<td>" . $row["KARYAWAN_DUA"] . "</td>";
                        echo "<td>" . $row["DARI"] . "</td>";
                        echo "<td>" . $row["SELESAI"] . "</td>";
                        echo "<td>" . $row["TERCATAT_TGL"] . "</td>";
                        echo "<td><a href='surat.php?id=" . $row["id"] . "' class='btn btn-primary'>Ambil Data</a></td>";  // Link untuk mengambil data berdasarkan ID
                        echo "</tr>";
                    }
                } else {
