...
include 'koneksi.php';
    ...
    $sql = "SELECT * FROM rekrutmen ORDER BY id DESC LIMIT 1";  // Ganti "nama_tabel" dengan nama tabel Anda
 ...
 $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('rek.docx');
